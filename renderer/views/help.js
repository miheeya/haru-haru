function renderHelp(container) {
  container.innerHTML = `
    ...
    <div class="help-card">
      <h3>⚙️ 설정</h3>
      <ul>
        <li><strong>자동 시작</strong> — Windows 로그인 시 하루하루가 자동으로 시작되어 트레이에서 실행됩니다. 기록 누락을 방지합니다.</li>
    ...
    <div class="help-card">
      ...
      <ul>
        ...
        <li>트레이 우클릭 메뉴에서 추적 일시정지/재개, 자동 시작 설정이 가능합니다.</li>
        <li>자동 시작을 켜두면 PC를 재시작해도 기록이 누락되지 않습니다.</li>
        <li>새 버전이 출시되면 앱 상단에 알림 배너가 표시됩니다.</li>
